...
bool ccc_prepare_chunks(struct ccc_chunk *, void *,
			struct ccc_crypto_req *, unsigned int *);
...
struct ccc_channel *trng_get_channel(void *);
int trng_init(struct ccc_controller *, int);
void *trng_crypto_init(struct ccc_crypto_req *req,
		       struct ccc_dispatcher *dispatcher);
int trng_program_prolog(void *);
int trng_program(void *);
int trng_program_epilog(void *);

struct ccc_channel *mpaes_get_channel(void *);
int mpaes_init(struct ccc_controller *, int, unsigned short, unsigned short);
void *mpaes_crypto_init(struct ccc_crypto_req *req,
			struct ccc_dispatcher *dispatcher);
int mpaes_program_prolog(void *);
int mpaes_program(void *);
int mpaes_program_epilog(void *);
void mpaes_post_processing(void *);

struct ccc_channel *pka_get_channel(void *);
int pka_init(struct ccc_controller *, int);
void *pka_crypto_init(struct ccc_crypto_req *req,
		      struct ccc_dispatcher *dispatcher);
int pka_program_prolog(void *);
int pka_program(void *);
int pka_program_epilog(void *);
int pka_post_processing(void *);

struct ccc_channel *move_get_channel(void *);
int move_init(struct ccc_controller *, int);
void *move_crypto_init(struct ccc_crypto_req *req,
		       struct ccc_dispatcher *dispatcher);
int move_program(void *);

struct ccc_channel *hash_get_channel(void *);
bool hash_is_alg_supported(unsigned int alg);
int hash_init(struct ccc_controller *, int);
void *hash_crypto_init(struct ccc_crypto_req *req,
		       struct ccc_dispatcher *dispatcher);
int hash_program_prolog(void *);
int hash_program(void *);
int hash_program_epilog(void *);
void hash_post_processing(void *);
#endif /* _CCC_H_ */
