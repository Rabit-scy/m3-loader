...
#ifndef NO_SCHEDULER
/* Define to make use of interruption handling instead of polling. */
#define HAVE_INTERRUPT

/* Define if a semaphore API is available. */
#define HAVE_SEM
#endif /* NO_SCHEDULER */
...
semaphore_t create_sem(void);
bool take_sem(semaphore_t);
bool give_sem(semaphore_t);
#endif /* _CCC_OSAL_H_ */
