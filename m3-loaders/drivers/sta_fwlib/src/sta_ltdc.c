...
#define GCR_GACREN	0x00000002 /* Gamma correction enable */
#define GCR_DITHEN	0x00010000 /* Dithering enable */

#define HSPOL_AL	0x00000000 /* Horizontal Sync Pol Active Low */
#define HSPOL_AH	GCR_HSPOL  /* Horizontal Sync Pol Active High */
#define VSPOL_AL	0x00000000 /* Vertical Sync Pol Active Low */
#define VSPOL_AH	GCR_VSPOL  /* Vertical Sync Pol Active High */
#define DEPOL_AL	0x00000000 /* Data Enable Pol Active Low */
#define DEPOL_AH	GCR_DEPOL  /* Data Enable Pol Active High */
