...
DDRSETTING(0x0000000a/*TIMING_INIT1*/, DDR3_CTRL_BASE + INIT(1), UMCTL2_INIT(1))
...
DDRSETTING(0x0002030c/*TIMING_DRAMTMG1*/, DDR3_CTRL_BASE + DRAMTMG(1), UMCTL2_DRAMTMG(1))
...
DDRSETTING(0x00470012/*TIMING_ZQCTL0*/, DDR3_CTRL_BASE + ZQCTL0, UMCTL2_ZQCTL0)
