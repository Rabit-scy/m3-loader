...
#else
/* Reserved 5M area at the end of the DRAM */
#define EXT_MEM_RANGE_INOUT_START	(DDRAM_BASE + DDRAM_SIZE - 0x500000)
#define EXT_MEM_RANGE_INOUT_END		(DDRAM_BASE + DDRAM_SIZE - 1)
#endif
...
void m3_set_ap_sync_point(uint32_t);
